...
// define flags
  ...
  constexpr bool writeSignal = true;
	...
	std::string normal_bias_grd = "normal_bias_52_0000_lgad_des.grd";
	std::string normal_bias_dat = "normal_bias_52_0000_lgad_des.dat";
...
// weighting field from tcad file
	...
	dwp_1.SetWeightingField(normal_bias_dat, "dynamic_n52_0000_lgad_des.dat", dv, "pad1-delayed");
	dwp_2.SetWeightingField(normal_bias_dat, "dynamic_n53_0000_lgad_des.dat", dv, "pad2-delayed");
	dwp_3.SetWeightingField(normal_bias_dat, "dynamic_n54_0000_lgad_des.dat", dv, "pad3-delayed");
	dwp_4.SetWeightingField(normal_bias_dat, "dynamic_n55_0000_lgad_des.dat", dv, "pad4-delayed");
	dwp_5.SetWeightingField(normal_bias_dat, "dynamic_n56_0000_lgad_des.dat", dv, "pad5-delayed");
	
	double start = 4.e-3;
	double end = 5.;
	double q = pow(end / start, 1./50);
	std::vector<double> dy_times;
	std::string prefix_1 = "dynamic_n52_";
	std::string prefix_2 = "dynamic_n53_";
	std::string prefix_3 = "dynamic_n54_";
	std::string prefix_4 = "dynamic_n55_";
	std::string prefix_5 = "dynamic_n56_";
